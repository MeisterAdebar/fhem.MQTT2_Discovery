...
ok(eval { require MQTT2_Discovery::Parser::Sonos2mqtt; 1 }, 'Sonos2mqtt-Parser laedt') or diag $@;
...
ok(eval { require MQTT2_Discovery::Format::Sonos2mqtt; 1 }, 'Sonos2mqtt-Formatadapter laedt') or diag $@;
